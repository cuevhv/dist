...
if (strcmpi(ext,'ply'))
    ...
    [pc,ind] = removeInvalidPoints(ptCloud);    
    ...
    propertyNames = [propertyNames, {'ind'}];
    propertyValues = [propertyValues, {uint32(ind)}];
    % ind indicates valid and invalid point of the original point cloud
